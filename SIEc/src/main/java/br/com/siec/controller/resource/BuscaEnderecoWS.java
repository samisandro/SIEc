 ...
 * {@link BuscaEnderecoWS#searchCep(String)} para maiores informa��es.
 * <BR>
 * <BR>Constroi um objeto {@link BuscaEnderecoWS} com os dados XML encapsulados, a
 * partir da chamada do m�todo estatico {@link BuscaEnderecoWS#searchCep(String)}.
 * <BR>
 ...
 * <BR>
 * <BR>Exemplo de uso:
 * <BR><tt>{@link BuscaEnderecoWS} cep =
 * {@link BuscaEnderecoWS}.searchCep("13345-325");
 *
 ...
 */
public final class BuscaEnderecoWS {
     ...
     * {@link Xml#setCep(String, BuscaEnderecoWS)}.
     *
     * @author Tomaz Lavieri
     */
    private enum Xml {
        ...
        CIDADE {
            @Override
            public void setCep(String text, BuscaEnderecoWS webServiceCep) {
         ...
         * {@link BuscaEnderecoWS} no seu parametro correspondente. Cada constante
         * do enum conhece o seu parametro a passar.
         *
         * @param text {@link String} contendo o texto a ser inserido.
         * @param webServiceCep {@link BuscaEnderecoWS} referencia do objeto para
         * inserir o parametro text.
         */
        public abstract void setCep(String text, BuscaEnderecoWS webServiceCep);
    }
     ...
     * caracters.
     * @return {@link BuscaEnderecoWS} contendo as informa��es da pesquisa.
     */
    public static BuscaEnderecoWS searchCep(String cep) {
        cep = cep.replaceAll("\\D*", ""); //To numeric digits only
        if (cep.length() > 8) {
            cep = cep.substring(0, 8);
        }
        BuscaEnderecoWS loadCep = new BuscaEnderecoWS(cep);
        try {
     ...
     * @param cep
     */
    private BuscaEnderecoWS(String cep) {
        this.cep = cep;
    }
